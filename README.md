...
- 🌐 [**Site Gerenciador de Eventos**](https://github.com/gus-ant/epf-ta-marcado)  
  Aplicação web para gerenciamento de eventos, estruturada no padrão **MVC**.  
  *Stack:* HTML, CSS, Python (Bottle), JSON
  [![My Skills](https://skillicons.dev/icons?i=html,css,python)](https://skillicons.dev)

- 🧮 [**Sistema Estudantil**](https://github.com/Velho008/ep1-OO-2025_Gabriel_Velho)  
  Projeto acadêmico para gestão de dados estudantis, com foco em reforçar conceitos de **Programação Orientada a Objetos**.  
  *Stack:* Java
